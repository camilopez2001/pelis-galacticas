...
describe('MoviesController', () => {
  ...
  describe('allMovies', () => {
    it('should return an array of movies', async () => {
      ...
      jest
        .spyOn(moviesService, 'allMovies')
        .mockImplementation(() => of(movies));

      expect(await moviesController.allMovies()).toBe(movies);
    });
  });
  ...
  describe('oneMovie', () => {
    it('should return a single movie', async () => {
      ...
      const movieID = 3;
      jest.spyOn(moviesService, 'oneMovie').mockImplementation(() => of(movie));

      expect(await moviesController.oneMovie(movieID)).toBe(movie);
    });
  });
});
